...
ZGL is a minimalistic wrapper on top of WebGL2 JS API. It's designed to reduce the amount of boilerplate code required to manage GLSL shaders, textures and framebuffers when making GPGPU-style procedural visualizations or simulations. See the [demos](src/demos/) for examples of using ZGL. As of now the library consists of a standalone ~700 loc .js file.
