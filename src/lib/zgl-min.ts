...
const gl: GL & { _indexVA?: VA } = canvas.getContext('webgl2', { alpha: false, antialias: true })!;
...
export const z = (params: Params, target?: Target | null) => drawQuads(params, target);
