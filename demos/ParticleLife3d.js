...
export default class ParticleLife3d extends ParticleLife {
  ...
  frame(_, params) {
    ...
    const shadowmap = z({ Clear: 0 }, { size: [2048, 2048], format: 'depth', tag: 'shadowmap' });
    this.drawPoints(z, { ...params, shadowPass: true }, shadowmap);
    params = { ...params, shadowmap, shadowPass: false, Aspect: 'fit' };
    this.drawPoints(z, params);
